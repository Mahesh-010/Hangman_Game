...
// Add HangmanPanel
        ...
        hangmanPanel.setBounds(10, 20, 380, 500);
...
// Display "Guess the word" label
        ...
        guessText.addActionListener(e -> processGuess()); // Add ActionListener to JTextField
        guessButton.addActionListener(e -> processGuess());
// Add the wrong guesses label
...
// Update the panel to repaint with new components
    ...
    private String getRandomWord() {
        String[] wordList = {"RVITM", "LINUX", "PROGRAMMING", "SWINGLIBRARY", "PYTHON",
                "COMPILER", "DEBUGGER", "JAVASCRIPT", "ANDROID", "SYNTAX", "DATABASE", "WINDOWS",
                "COMPUTER"};
            ...
            if (!wrongGuesses.contains(guessedLetter)) {
                if (randomWord.indexOf(guessedLetter) != -1) {
                    if (wordLabel.getText().indexOf(guessedLetter) != -1) {
                        JOptionPane.showMessageDialog(null, "You have already guessed '" + guessedLetter
                                + "' correctly.", "Already Guessed", JOptionPane.ERROR_MESSAGE);
                    } else {
...
// Clear the guessText for the next guess
                ...
                JOptionPane.showMessageDialog(null, "You already guessed '" + guessedLetter + "'.",
